        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <Card className="p-8 mb-8">
            <section className="space-y-6">
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">1. はじめに</h2>
                <p className="text-gray-700 leading-relaxed">
                  Yomogi Server（以下「本サーバー」）をご利用いただき、ありがとうございます。
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">2. 基本ルール</h2>
                <ul className="space-y-3 list-disc list-inside text-gray-700">
                  <li>他のプレイヤーを尊重し、楽しいコミュニティを維持してください</li>
                  <li>チート、ハッキング、不正なModの使用は禁止されています</li>
                  <li>他のプレイヤーの建築物を無断で破壊・改変しないでください</li>
                  <li>スパム、荒らし行為、過度な宣伝は禁止です</li>
                  <li>個人情報の公開や要求は行わないでください</li>
                  <li>サーバーのパフォーマンスに悪影響を与える行為は避けてください</li>
                </ul>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">3. チャット・コミュニケーション</h2>
                <ul className="space-y-3 list-disc list-inside text-gray-700">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">4. 建築・資源</h2>
                <ul className="space-y-3 list-disc list-inside text-gray-700">
                  <li>他のプレイヤーのエリアから適切な距離を保って建築してください</li>
                  <li>共有資源は適度に利用し、独占しないようにしてください</li>
                  <li>大規模な自動化装置を作る場合は、事前に運営に相談してください</li>
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">5. イベント参加</h2>
                <ul className="space-y-3 list-disc list-inside text-gray-700">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">6. 処罰について</h2>
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">7. 免責事項</h2>
                <ul className="space-y-3 list-disc list-inside text-gray-700">
                  <li>サーバーのデータ損失やロールバックに対して、運営は責任を負いません</li>
                  <li>サーバーの一時的な停止やメンテナンスによる影響について責任を負いません</li>
                  <li>ユーザー間のトラブルは当事者間で解決してください</li>
                  <li>Minecraft本体のバグや仕様変更による影響は保証できません</li>
                </ul>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">8. プライバシー</h2>
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">9. 規約の変更</h2>
                <p className="text-gray-700">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-primary">10. お問い合わせ</h2>
                <p className="text-gray-700">
